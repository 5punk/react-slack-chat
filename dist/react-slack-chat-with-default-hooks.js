...
*/ var t =
    ...
    function(e, A, n) {
      ...
      D.propTypes = {
        ...
        stylesCard: s.a.string,
        stylesCardActive: s.a.string,
        stylesHelper: s.a.string,
        stylesNotificationsBadge: s.a.string,
        stylesChatPersonn: s.a.string,
        stylesChatHeader: s.a.string,
        stylesChatInputText: s.a.string,
        stylesChatMessage: s.a.string,
